<template>
    <div>
        ...
        <div style="margin-bottom: 5px;">
            <el-input v-model="name" placeholder="请输入分类名" :suffix-icon="Search" style="width: 200px;"
...
function del(id: any) {
    // console.log(id);
    axios.get('/goodstype/del?id=' + id).then(res => res.data).then(res => {
        // console.log(res)
        if (res.code === 200) {
            ElMessage({
                message: '数据删除成功',
...
function doSave() {
    axios.post('/goodstype/save', form).then(res => res.data).then(res => {
        // console.log(res)
        if (res.code === 200) {
            ElMessage({
                message: '数据添加成功',
...
function doMod() {
    axios.post('/goodstype/update', form).then(res => res.data).then(res => {
        // console.log(res)
        if (res.code === 200) {
            ElMessage({
                message: '数据修改成功',
